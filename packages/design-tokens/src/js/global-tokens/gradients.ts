...
export const gradientSkeleton = 'linear-gradient(var(--gradient-angle, 135deg), var(--spirit-color-gradient-skeleton-color-01, #e5e5e5) 0%, var(--spirit-color-gradient-skeleton-color-02, #fff) 48.5%, var(--spirit-color-gradient-skeleton-color-03, #e5e5e5) 100%)';
