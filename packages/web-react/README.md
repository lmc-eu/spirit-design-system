...
All Spirit components accept a set of props that can be used to control their outer spacing and visibility. The props are:
...
The component will be hidden at the specified breakpoints using CSS display utilities.
