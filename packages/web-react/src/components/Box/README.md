...
| -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | -------- | ------------------------------ |
| `backgroundColor`    | \[[Background Color dictionary][dictionary-color] \| [AccentColorNamesType][generated-types] \| [EmotionColorNamesType][generated-types] ✕ [Intensity dictionary][dictionary-intensity]] | -       | ✕        | Background color of the Box    |
...
| `borderRadius`       | \[[BorderRadiiTokenType \| `Partial<Record<BreakpointToken, BorderRadiiTokenType>>`][generated-types]                                                                                    | -       | ✕        | Border radius of the Box       |
...
| `textColor`          | \[[TextColorNamesType \| AccentColorNamesType \| EmotionColorNamesType][generated-types] ✕ [Intensity dictionary][dictionary-intensity]]                                                 | -       | ✕        | Color of the text              |
