...
export const Tag = ({ color, theme, children, className }: TagProps): JSX.Element => (
  <span className={classNames('Tag', getTagColorAndThemeClassname(color, theme), className)}>{children}</span>
);
