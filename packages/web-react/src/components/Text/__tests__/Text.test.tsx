...
import { DictionarySizeExtendedType, DictionarySizeType, TextEmphasis } from '../../../types';
...
describe('Text', () => {
  ...
  it.each(textPropsDataProvider)('should have classname', (size, emphasis, expectedClassName) => {
    const dom = render(
      <Text size={size as DictionarySizeType as DictionarySizeExtendedType} emphasis={emphasis as TextEmphasis} />,
    );
