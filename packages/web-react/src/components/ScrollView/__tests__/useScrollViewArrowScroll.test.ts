...
describe('useScrollViewArrowScroll', () => {
  it('should return handleScroll function', () => {
    const viewportRef = createRef<HTMLDivElement>();
    const { result } = renderHook(() => useScrollViewArrowScroll({ viewportRef, direction: Direction.HORIZONTAL }));
  ...
  describe('vertical scrolling', () => {
    it('should call scrollTo with correct values for positive step', () => {
      ...
      const { result } = renderHook(() => useScrollViewArrowScroll({ viewportRef, direction: Direction.VERTICAL }));
  ...
  describe('cleanup', () => {
    it('should cleanup timeout on unmount', () => {
      ...
      const { result, unmount } = renderHook(() =>
        useScrollViewArrowScroll({ viewportRef, direction: Direction.HORIZONTAL }),
      );
