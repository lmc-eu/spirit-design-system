...
const Story: ComponentStory<typeof ScrollView> = (args: SpiritScrollViewProps) => (
...
Story.args = {
  ...
  children: (
    <p>
      ...
      consequat, leo eget bibendum sodales, augue velit cursus nunc. Lorem ipsum dolor sit amet, consectetuer adipiscing
