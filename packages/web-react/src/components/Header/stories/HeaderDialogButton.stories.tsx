...
const meta: Meta<typeof HeaderDialogButton> = {
  title: 'Components/Header',
  component: HeaderDialogButton,
  argTypes: {
    children: {
      control: 'object',
    },
...
export default meta;
type Story = StoryObj<typeof HeaderDialogButton>;
...
export const HeaderDialogButtonPlayground: Story = {
  name: 'HeaderDialogButton',
