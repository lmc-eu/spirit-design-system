...
const meta: Meta<typeof HeaderDialogActions> = {
  title: 'Components/Header',
  component: HeaderDialogActions,
  argTypes: {
    children: {
      control: 'object',
    },
...
export default meta;
type Story = StoryObj<typeof HeaderDialogActions>;

const HeaderWithHooks = (args: HeaderDialogActionsProps) => {
  ...
  return (
    <>
      ...
      <HeaderDialog id="header-dialog-example-1" aria-label="Menu" isOpen={isMenuOpen} onClose={handleMenuClose}>
        <HeaderDialogCloseButton />
        <HeaderDialogActions {...args} aria-label="Main navigation">
          <HeaderDialogNav>
            <HeaderDialogNavItem>
...
export const HeaderDialogActionsPlayground: Story = {
  name: 'HeaderDialogActions',
