...
export default meta;
type Story = StoryObj<typeof HeaderDialogNavItem>;

const HeaderWithHooks = (args: HeaderDialogNavItemProps) => {
...
export const HeaderDialogNavItemPlayground: Story = {
  name: 'HeaderDialogNavItem',
