...
const FooterTextAlignment = () => {
  const [textAlignment, setTextAlignment] = useState<AlignmentXDictionaryType>(AlignmentX.LEFT);

  const handleTextAlignChange = (event: ChangeEvent<HTMLInputElement>) => {
    setTextAlignment(event.target.value as AlignmentXDictionaryType);
  };
        ...
        <Box elementType="form" marginBottom="space-600">
          <Box elementType="fieldset" borderWidth="0">
            ...
            <Radio
              ...
              name="text-alignment"
              autoComplete="off"
              isChecked={textAlignment === AlignmentX.LEFT}
            ...
            <Radio
              ...
              name="text-alignment"
              autoComplete="off"
              isChecked={textAlignment === AlignmentX.CENTER}
              onChange={handleTextAlignChange}
            />{' '}
            <Radio
              ...
              name="text-alignment"
              autoComplete="off"
              isChecked={textAlignment === AlignmentX.RIGHT}
              onChange={handleTextAlignChange}
            />
          </Box>
        </Box>
