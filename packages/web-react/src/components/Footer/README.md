...
| ----------------- | ---------------------------------------------------- | ------------ | -------- | ----------------------------------------------- |
| `backgroundColor` | [Background dictionary][dictionary-background-color] | `secondary`  | ✕        | Sets the background color of the footer         |
...
[dictionary-background-color]: https://github.com/lmc-eu/spirit-design-system/blob/main/docs/DICTIONARIES.md#backgroundColor
