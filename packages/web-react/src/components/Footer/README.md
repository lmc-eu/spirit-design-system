...
You can set the text alignment of the Footer using the `textAlignment` prop. Default is left-aligned.
...
| `textAlignment`   | \[[AlignmentX dictionary][dictionary-alignment] \| `object`] | `left`       | ✕        | Alignment of the text                           |
