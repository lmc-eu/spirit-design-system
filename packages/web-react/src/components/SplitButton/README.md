...
👉 The **color** variant and **size** of the buttons are defined at the `SplitButton` component level and apply uniformly to **all buttons** within it.
...
<SplitButton>
  <Button>Button</Button>
  <Tooltip id="split-button-tooltip-id" isOpen={open} onToggle={setOpen}>
