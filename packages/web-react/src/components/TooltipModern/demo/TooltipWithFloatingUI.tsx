...
const TooltipWithFloatingUI = () => {
  ...
  return (
    <div className="spirit-feature-tooltip-enable-data-placement">
      ...
      <Grid cols={{ mobile: 1, tablet: 2, desktop: 4 }} UNSAFE_className="mb-700">
      ...
      <Grid cols={{ mobile: 1, tablet: 2, desktop: 2 }} UNSAFE_className="mb-700">
        <Select
        ...
        <Select
          ...
          label="Suggested fallback placement"
      ...
      >
        ...
        >
          <TooltipModern
            ...
            enableSizing={size}
          >
            <TooltipTrigger elementType={Button}>I have a flipping tooltip!</TooltipTrigger>
            <TooltipPopover>
