...
describe('useControlButtonStyleProps', () => {
  it.each([
    ...
    [
      ...
      false,
      false,
      'ControlButton ControlButton--medium dynamic-color-background-interactive accessibility-tap-target dynamic-color-border',
    ],
    [
      'small',
      false,
      false,
      false,
      'ControlButton ControlButton--small dynamic-color-background-interactive accessibility-tap-target dynamic-color-border',
    ],
    [
      'large',
      false,
      false,
      false,
      'ControlButton ControlButton--large dynamic-color-background-interactive accessibility-tap-target dynamic-color-border',
    ],
    [
      'medium',
      true,
      false,
      false,
      'ControlButton ControlButton--medium dynamic-color-background-interactive accessibility-tap-target ControlButton--disabled dynamic-color-border',
    ],
    [
      'medium',
      false,
    ...
    [
      ...
      false,
      true,
      'ControlButton ControlButton--medium dynamic-color-background-interactive accessibility-tap-target ControlButton--symmetrical dynamic-color-border',
    ],
    [
      'medium',
      true,
