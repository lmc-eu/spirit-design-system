...
```jsx
import { Tooltip, TooltipTrigger, TooltipPopover } from '@alma-oss/spirit-web-react/components';
...
```jsx
import { Tooltip, TooltipTrigger, TooltipPopover, Button } from '@alma-oss/spirit-web-react/components';
