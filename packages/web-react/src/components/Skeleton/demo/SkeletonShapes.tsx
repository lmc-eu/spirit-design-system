...
const SkeletonShapes = () => (
  <Grid cols={{ mobile: 1, tablet: 2, desktop: 3 }} spacingY="space-1100">
    <DocsSection title="Shape Square" stackAlignment="stretch" container="none" hasPadding={false}>
      <SkeletonShape width={100} height={100} />
    </DocsSection>

    <DocsSection title="Shape Circle" stackAlignment="stretch" container="none" hasPadding={false}>
      <SkeletonShape width={100} height={100} borderRadius="full" />
    </DocsSection>

    <DocsSection title="Shape Rectangular" stackAlignment="stretch" container="none" hasPadding={false}>
      <SkeletonShape width={300} height={100} borderRadius="400" />
    </DocsSection>

    <DocsSection
      title="Shape Rectangular responsive radius"
