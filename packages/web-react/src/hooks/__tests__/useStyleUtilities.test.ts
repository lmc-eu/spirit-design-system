...
describe('useStyleUtilities hook', () => {
  it('should process style utilities correctly', () => {
    ...
    expect(result.current.styleUtilities).toEqual([
      ...
      'test-prefix-d-tablet-only-none',
  ...
  it('should process style utilities with additional spacing props', () => {
    ...
    expect(result.current.styleUtilities).toEqual([
      ...
      'test-prefix-d-mobile-only-none',
      'test-prefix-d-desktop-none',
    ]);
  });
  ...
  it('should process hideOn utility with single breakpoint', () => {
    ...
    expect(result.current.styleUtilities).toEqual(['d-tablet-only-none']);
  });
  ...
  it('should process hideOn utility with multiple breakpoints', () => {
    ...
    expect(result.current.styleUtilities).toEqual(['d-mobile-only-none', 'd-desktop-only-none']);
  });
  ...
  it('should process both hideOn and hideFrom utilities together', () => {
    ...
    expect(result.current.styleUtilities).toEqual(['d-tablet-only-none', 'd-desktop-only-none', 'd-none']);
  });

  it('should process hide utilities with prefix', () => {
    const mockProps = {
      hideOn: ['tablet', 'desktop'],
      hideFrom: 'mobile',
    };
    ...
    expect(result.current.styleUtilities).toEqual([
      'test-prefix-d-tablet-only-none',
      'test-prefix-d-desktop-only-none',
      'test-prefix-d-none',
    ]);
  });
});
