...
- **web-react:** Add the option to allow visited state in Link [#DS-1501](https://github.com/lmc-eu/spirit-design-system/issues/DS-1501) ([af1e9b3](https://github.com/lmc-eu/spirit-design-system/commit/af1e9b3))
- **web-react:** Build library for ES6 ([9b03978](https://github.com/lmc-eu/spirit-design-system/commit/9b03978))
- **web-react:** Button/ButtonLink have isSymmetrical prop instead of isSquare [#DS-1484](https://github.com/lmc-eu/spirit-design-system/issues/DS-1484) ([c00cabb](https://github.com/lmc-eu/spirit-design-system/commit/c00cabb))
...
- **web-react:** Remove action colors from Pill [#DS-1446](https://github.com/lmc-eu/spirit-design-system/issues/DS-1446) ([f45baf9](https://github.com/lmc-eu/spirit-design-system/commit/f45baf9))
...
- **web-react:** Remove default elementType value for Heading component ([5c76b66](https://github.com/lmc-eu/spirit-design-system/commit/5c76b66))
...
- **web-react:** Remove inverted variant from Button and ButtonLink [#DS-1445](https://github.com/lmc-eu/spirit-design-system/issues/DS-1445) ([f4e8e1f](https://github.com/lmc-eu/spirit-design-system/commit/f4e8e1f))
- **web-react:** Remove inverted variant of `ProductLogo` [#DS-1450](https://github.com/lmc-eu/spirit-design-system/issues/DS-1450) ([b94ec64](https://github.com/lmc-eu/spirit-design-system/commit/b94ec64))
- **web-react:** Remove isUnderlined prop from Link component ([f882691](https://github.com/lmc-eu/spirit-design-system/commit/f882691)), closes [#DS-1509](https://github.com/lmc-eu/spirit-design-system/issues/DS-1509)
...
- **web-react:** Rename `inverted` variant of `Toast` to `neutral` [#DS-1446](https://github.com/lmc-eu/spirit-design-system/issues/DS-1446) ([c5f8f42](https://github.com/lmc-eu/spirit-design-system/commit/c5f8f42))
...
- **web-react:** Switch `Header` component to v3 design tokens [#DS-1453](https://github.com/lmc-eu/spirit-design-system/issues/DS-1453) ([9d4e319](https://github.com/lmc-eu/spirit-design-system/commit/9d4e319))
- **web-react:** Switch Link, Heading and Text to v3 design tokens [#DS-1451](https://github.com/lmc-eu/spirit-design-system/issues/DS-1451) ([1bae0ae](https://github.com/lmc-eu/spirit-design-system/commit/1bae0ae))
...
- **web-react:** Unsupported export in client boundary [#DS-1549](https://github.com/lmc-eu/spirit-design-system/issues/DS-1549) ([f9fbc6f](https://github.com/lmc-eu/spirit-design-system/commit/f9fbc6f))
- **web-react:** Unwanted Heading elementType prop on a DOM element [#DS-1553](https://github.com/lmc-eu/spirit-design-system/issues/DS-1553) ([f6290a3](https://github.com/lmc-eu/spirit-design-system/commit/f6290a3))
- **web-react:** Unwanted Link hasVisitedStyleAllowed prop on a DOM element [#DS-1553](https://github.com/lmc-eu/spirit-design-system/issues/DS-1553) ([c721ee5](https://github.com/lmc-eu/spirit-design-system/commit/c721ee5))
...
- **release:** Publish ([6d943c5](https://github.com/lmc-eu/spirit-design-system/commit/6d943c5))
...
- **release:** Publish ([31f0b6e](https://github.com/lmc-eu/spirit-design-system/commit/31f0b6e))
...
- **release:** Publish ([914a477](https://github.com/lmc-eu/spirit-design-system/commit/914a477))
...
- **release:** Publish ([df2e53d](https://github.com/lmc-eu/spirit-design-system/commit/df2e53d))
...
- **release:** Publish [ci-skip] ([fbad1b8](https://github.com/lmc-eu/spirit-design-system/commit/fbad1b8))
...
- **release:** Publish [ci-skip] ([6262a94](https://github.com/lmc-eu/spirit-design-system/commit/6262a94))
- **release:** Publish [ci-skip] ([0f7f170](https://github.com/lmc-eu/spirit-design-system/commit/0f7f170))
...
- **release:** Publish [ci-skip] ([bd947b0](https://github.com/lmc-eu/spirit-design-system/commit/bd947b0))
- **release:** Publish [ci-skip] ([0c2129d](https://github.com/lmc-eu/spirit-design-system/commit/0c2129d))
...
- **web-react,web-twig:** Use new spacing tokens values in ScrollView [#DS-1451](https://github.com/lmc-eu/spirit-design-system/issues/DS-1451) ([c7974fd](https://github.com/lmc-eu/spirit-design-system/commit/c7974fd))
- **web-react,web-twig:** Use new spacing tokens values in Tooltip [#DS-1451](https://github.com/lmc-eu/spirit-design-system/issues/DS-1451) ([5767425](https://github.com/lmc-eu/spirit-design-system/commit/5767425))
...
- **web-react:** Add more disabled combinations to Toggle demo [#DS-1449](https://github.com/lmc-eu/spirit-design-system/issues/DS-1449) ([929af7c](https://github.com/lmc-eu/spirit-design-system/commit/929af7c))
...
- **web-react:** Switch Avatar demo spacings to v3 design token values [#DS-1450](https://github.com/lmc-eu/spirit-design-system/issues/DS-1450) ([00a75c4](https://github.com/lmc-eu/spirit-design-system/commit/00a75c4))
...
- **web-react:** Use correct typography helper and spacings in Flex [#DS-1444](https://github.com/lmc-eu/spirit-design-system/issues/DS-1444) ([a7ef324](https://github.com/lmc-eu/spirit-design-system/commit/a7ef324))
...
- **web-react:** Add spacingX and spacingY to Flex [#DS-1427](https://github.com/lmc-eu/spirit-design-system/issues/DS-1427) ([1005644](https://github.com/lmc-eu/spirit-design-system/commit/1005644))
...
- **web-react:** Prop `hasSafeAreaDisabled` changed to `hasSafeArea` in `PartnerLogo` component ([1ee299c](https://github.com/lmc-eu/spirit-design-system/commit/1ee299c)), closes [#DS-1373](https://github.com/lmc-eu/spirit-design-system/issues/DS-1373)
...
- **web-react:** Rename spaces token object ([9764769](https://github.com/lmc-eu/spirit-design-system/commit/9764769))
...
- **web-react:** Stabilization of PartnerLogo component [#DS-1443](https://github.com/lmc-eu/spirit-design-system/issues/DS-1443) ([8a66345](https://github.com/lmc-eu/spirit-design-system/commit/8a66345))
- **web-react:** Stabilization of ProductLogo component [#DS-1374](https://github.com/lmc-eu/spirit-design-system/issues/DS-1374) ([83ee4c9](https://github.com/lmc-eu/spirit-design-system/commit/83ee4c9))
...
- **web-react:** Switch Footer component to v3 design tokens ([cec9980](https://github.com/lmc-eu/spirit-design-system/commit/cec9980))
