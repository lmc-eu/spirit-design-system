...
<div class="Toggle">
  <div class="Toggle__text">
    <label class="Toggle__label" for="toggle-default" id="toggle-default-label">Toggle Label</label>
  </span>
  <input type="checkbox" id="toggle-default" class="Toggle__input" name="default" aria-labelledby="toggle-default-label" />
</div>
```
...
<div class="Toggle">
  <div class="Toggle__text">
    <label class="Toggle__label" for="toggle-indicators" id="toggle-indicators-label">Toggle Label</label>
  </div>
  <input
    type="checkbox"
    ...
    name="default"
    aria-labelledby="toggle-indicators-label"
  />
</div>
```
...
<div class="Toggle">
  <div class="Toggle__text">
    <label class="Toggle__label Toggle__label--required" for="toggle-required" id="toggle-required">Toggle Label</label>
  </div>
  <input
    type="checkbox"
    id="toggle-required"
...
<div class="Toggle">
  <div class="Toggle__text">
    <label class="Toggle__label Toggle__label--hidden" for="toggle-hidden-label" for="toggle-hidden-label-label"
      >Toggle Label</label
    >
  </div>
  <input
    ...
    class="Toggle__input"
    name="hidden-label"
    aria-labelledby="toggle-hidden-label-label"
  />
</div>
```
...
<div class="Toggle Toggle--fluid">
  <div class="Toggle__text">
    <label class="Toggle__label" for="toggle-fluid" id="toggle-fluid-label">Toggle Label</label>
  </div>
  <input type="checkbox" id="toggle-fluid" class="Toggle__input" name="fluid" aria-labelledby="toggle-fluid-label" />
</div>
```
...
<div class="Toggle">
  <div class="Toggle__text">
    <label class="Toggle__label" for="toggle-helper-text" id="toggle-helper-text-label">Toggle Label</label>
  ...
  <input
    ...
    class="Toggle__input"
    name="helper-text"
    aria-labelledby="toggle-helper-text-label"
...
<div class="Toggle Toggle--success">
  <div class="Toggle__text">
    <label class="Toggle__label" for="toggle-success" id="toggle-success-label">Toggle Label</label>
  </div>
  <input
    type="checkbox"
    id="toggle-success"
    class="Toggle__input"
    name="default"
    aria-labelledby="toggle-success-label"
  />
</div>

<div class="Toggle Toggle--warning">
  <div class="Toggle__text">
    <label class="Toggle__label" for="toggle-warning" id="toggle-warning-label">Toggle Label</label>
  ...
  <input
    ...
    class="Toggle__input"
    name="default"
    aria-labelledby="toggle-warning-label"
...
<div class="Toggle Toggle--danger">
  <div class="Toggle__text">
    <label for="toggle-danger" id="toggle-danger-label" class="Toggle__label">Toggle Label</label>
  ...
  <input
    ...
    class="Toggle__input"
    name="default"
    aria-labelledby="toggle-danger-label"
...
<div class="Toggle Toggle--disabled">
  <div class="Toggle__text">
    <label class="Toggle__label" for="toggle-disabled" id="toggle-disabled-label">Toggle Label</label>
  </div>
  <input
    type="checkbox"
    id="toggle-disabled"
