...
- [Timeline](#timeline) – The main container
  - [TimelineItem](#timelineitem) – Individual timeline entry
...
ℹ️ TimelineItem uses the `<li>` element and should be a direct child of the Timeline container.
...
Currently, the `TimelineMarker--number` supports only numbers up to 99 (two digits).
