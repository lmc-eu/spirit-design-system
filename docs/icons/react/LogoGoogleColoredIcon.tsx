...
export interface LogoGoogleColoredIconProps extends React.SVGAttributes<SVGElement> {
size?: string | number;
}
const LogoGoogleColoredIcon: React.FC<LogoGoogleColoredIconProps> = ({size, ...props}) => (
...
LogoGoogleColoredIcon.displayName = 'LogoGoogleColoredIcon';
export default LogoGoogleColoredIcon;
/* tslint:enable */
/* eslint-enable */
