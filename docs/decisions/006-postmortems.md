...
Any failure that impacts users of the products they are using in our design system will be considered significant and must be documented in the postmortem.
...
- The decisions about the failures will require some decisions about how big the failure was and how big the impact on the products is to make a record from it.
