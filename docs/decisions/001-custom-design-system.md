...
- A design system is much more than libraries of components.
  With a custom solution, we can create our architecture, workflows, design patterns and automation tailored to the needs of [Alma Career](https://www.almacareer.com/) products.
