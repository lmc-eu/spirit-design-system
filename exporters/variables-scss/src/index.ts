...
import { generateSpacesObject, measuresTokenToCSS, otherTokenToCSS } from './content/token';
...
Pulsar.export(async (sdk: Supernova, context: PulsarContext): Promise<Array<AnyOutputFile>> => {
  ...
  const test = generate(tokens, mappedTokens, tokenGroups);
  ...
  return [
    ...
    createTextFile('./original-data/', '_test.scss', test),
  ];
});
