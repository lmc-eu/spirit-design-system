...
import { exampleDeviceTokens } from '../../../tests/fixtures/exampleDeviceTokens';
...
const mockedExpectedDeviceResult = fs.readFileSync(
  path.join(__dirname, '../../../tests/fixtures/exampleFileDeviceContent.scss'),
  'utf-8',
);
...
const mockedDeviceTsFile = `/* This file was generated by Supernova, don't change manually */
export const gridSpacingDesktop = 0;
export const gridSpacingMobile = 0;\n
export const grids = {
  spacing: {
    desktop: gridSpacingDesktop,
...
describe('fileGenerator', () => {
  describe('generateOutputFilesByThemes', () => {
    it('should generate output files by themes', async () => {
      const tokens = [
        ...Array.from(exampleDimensionAndStringTokens.values()),
        exampleDeviceTokens.get('stringRef1'),
      ] as Token[];

      const sdk = {
        tokens: {
          computeTokensByApplyingThemes: jest.fn().mockReturnValue([exampleDeviceTokens.get('stringRef1')]),
        },
      };
      ...
      const outputFiles = await generateOutputFilesByThemes(
        ...
        mappedTokens,
        tokenGroups,
        themes as unknown as TokenTheme[],
      ...
      expect(outputFiles).toStrictEqual([
        ...
        // Root barrel files
        {
          ...
          content: "@forward 'devices';\n@forward 'global-tokens';\n@forward 'themes';\n",
        },
        {
          path: './js/',
          fileName: 'index.ts',
          content: "export * from './devices';\nexport * from './global-tokens';\nexport * from './themes';\n",
        },
        // Themes files
        ...
        // Devices root barrel files
        { path: './scss/devices/', fileName: '_devices.scss', content: mockedExpectedDeviceResult },
        { path: './js/devices/', fileName: 'devices.ts', content: mockedDeviceTsFile },
        { path: './scss/devices/', fileName: 'index.scss', content: "@forward 'devices';\n" },
        { path: './js/devices/', fileName: 'index.ts', content: "export * from './devices';\n" },
      ]);
    });
  });
  ...
  describe('generateFiles', () => {
    it('should generate files', () => {
      ...
      const files = generateFiles(tokens, mappedTokens, tokenGroups, nonThemedFilesData, undefined, false, undefined);
