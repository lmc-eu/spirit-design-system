...
You can see which components are already connected by looking for files with the suffix `.figma.tsx` in their component directory.
...
yarn workspace @lmc-eu/spirit-web-react run figma:publish src/components/Button/Button.figma.tsx
